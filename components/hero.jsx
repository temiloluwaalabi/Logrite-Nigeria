...
const Hero = () => {
  return (
    ...
    >
        ...
        <div className='text-white z-30 md:grid md:grid-cols-12 items-center gap-x-12 w-full py-48 h-full'>
          ...
          <div className='lg:col-span-6 md:col-span-8 flex flex-col justify-center md:gap-y-4 gap-y-8 h-full'>
            <h2 className='lg:text-[55px] md:text-[45px] text-[33px] font-bold lg:leading-[60px] md:leading-[55px] leading-[48px] text-white'>
